...
public class BfhlResponse {
    ...
    public BfhlResponse(boolean is_success, String user_id, String email, String roll_number, List<String> numbers, List<String> alphabets, List<String> highest_lowercase_alphabet) {
